...
class ProductFeatureNotFound(ResourceNotFound):
    """
...
class ProductMediaNotFound(ResourceNotFound):
    """
    Raised when a product media item is not found
    """
    def __init__(
        self,
        identifier: str | int,
...
class SlugAlreadyExists(ConflictError):
    """
    Raised when a product slug already exists
    """
    def __init__(
        self,
        slug: str,
