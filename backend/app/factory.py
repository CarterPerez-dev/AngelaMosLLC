...
from product.admin_routes import router as product_admin_router
...
OPENAPI_TAGS = [
    ...
    {
        "name": "products",
        "description": "Product showcase and catalog"
    },
]
...
def create_app() -> FastAPI:
    ...
    app.include_router(product_admin_router, prefix = API_PREFIX)
